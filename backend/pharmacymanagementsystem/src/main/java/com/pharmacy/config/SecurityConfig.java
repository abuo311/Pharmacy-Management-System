    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasAnyAuthority("ADMIN", "ROLE_ADMIN", "PHARMACIST", "ROLE_PHARMACIST", "MANAGER",
                                "ROLE_MANAGER")
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/medicines", "/api/medicines/**")
                        ...
                        .hasAnyAuthority("CASHIER", "ROLE_CASHIER", "PHARMACIST", "ROLE_PHARMACIST", "ADMIN",
                                "ROLE_ADMIN", "MANAGER", "ROLE_MANAGER")

                        .requestMatchers(HttpMethod.GET, "/api/sales", "/api/sales/**")
                        .hasAnyAuthority("ADMIN", "ROLE_ADMIN", "MANAGER", "ROLE_MANAGER", "PHARMACIST",
